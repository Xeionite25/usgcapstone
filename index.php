...
<body class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
  <div class="w-full max-w-sm p-6 m-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
    <div class="flex justify-center">
      <img class="w-36 h-36 mx-auto" src="images/usglogo.png" alt="Logo">
    </div>

    <form class="mt-6" method="POST">
      <div>
        <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">Username</label>
        <input name="email" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
      </div>
      <!-- Create Dynamic User-->
      <?php
      if (isset($_POST['submit'])) {
        $stmt = $conn->prepare("INSERT INTO tbl_superauthkey (superauthkey_uname, superauthkey_authkey) VALUES (?, ?)");
      ...
      <div class="mt-4">
        ...
        <input name="password" type="password" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
    ...
    <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <a href="register_officer.php" class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</a></p>
  </div>
</body>
