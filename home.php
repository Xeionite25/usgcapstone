  ...
  <div class="flex h-screen">
    <aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      <div class="flex justify-center">
        <img src="images/usglogo.png" width="100px" height="100px" alt="USG Logo">
      </div>

      <div class="flex justify-center items-center flex-col space-y-4">
        <h1 class="text-center font-semibold text-gray-900 dark:text-white" style="font-size: 20px;">
          USG Electronic Records Management System
        </h1>
      </div>
      ...
      <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
            ...
            <span class="mx-4 font-medium">File Inventory</span>
          </a>
        ...
        <a href="#" class="flex items-center px-4 -mx-2">
          ...
          <span class="mx-2 font-medium text-gray-800 dark:text-gray-200">Adrian Miles R. Madulid</span>
          <br>
        </a>
      </div>
      <span class="mx-2 font-medium text-gray-800 dark:text-gray-200 ml-auto">Executive Secretary</span>
    </aside>
    ...
    <div class="flex-1 flex flex-col">
      ...
      <a href="index.php">
        <div class="pr-5 pt-5 flex">
          <button class="hover:cursor-pointer ml-auto px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
            Log Off
          </button>
        </div>
      </a>
      ...
      <main class="flex-1 p-6 overflow-y-auto">
        ...
        <div class="overflow-x-auto bg-white shadow-md rounded-lg p-4">
          <table class="w-full text-left border-collapse">
            ...
            <tbody>
              <tr class="border">
                <td class="p-3">2024-04-04</td>
                <td class="p-3">Login</td>
                <td class="p-3">User logged in successfully</td>
                <td class="p-3">
